...
craftingTable.addShaped("buildinggadgets_destruction_gadget", <item:buildinggadgets:gadget_destruction>, [
    [<item:the_vault:chromatic_steel_ingot>, <item:the_vault:void_liquid_bucket>, <item:the_vault:chromatic_steel_ingot>],
    [<item:the_vault:void_liquid_bucket>, <item:buildinggadgets:gadget_building>, <item:the_vault:void_liquid_bucket>],
    [<item:the_vault:chromatic_steel_ingot>, <item:the_vault:void_liquid_bucket>, <item:the_vault:chromatic_steel_ingot>]
]);
