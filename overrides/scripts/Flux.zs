...
<recipetype:create:item_application>.addRecipe("flux_flux_dust", [<item:fluxnetworks:flux_dust>, <item:fluxnetworks:flux_dust> %50],
<item:minecraft:redstone_block>, <item:the_vault:chromatic_iron_ingot>);
